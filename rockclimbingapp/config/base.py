"""
Django settings for rockclimbingapp project. Includes some improvements
...
SECRET_KEY = '(s+hyou=nr5g!yzykyki66-fb8_v4o73+70bo*ynap_^k&uh(y'
...
ROOT_URLCONF = 'rockclimbingapp.urls'
